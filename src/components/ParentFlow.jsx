...
// unified gradient CTA style (matches homepage energy) — FASTER hover
const ctaGradient =
...
// back button base style (animated)
const backBtnBase =
    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <motion.div
        ...
        transition={{
          duration: 18,
          repeat: Infinity,
          repeatType: "reverse", // smooth ping-pong loop
          ease: "linear",
        }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-full max-w-7xl items-start">
          ...
          <div className="relative bg-white/80 backdrop-blur rounded-2xl w-full p-8 sm:p-10 shadow-xl ring-1 ring-black/10 overflow-hidden">
            ...
            <AnimatePresence mode="wait" initial={false}>
              {step === "intro" && (
                ...
                >
                  <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome, Parents!</h1>
                  <p className="text-lg text-gray-700 mb-2">
                    I'm thrilled to help you support your student's academic journey!
                  </p>
                  <p className="text-base text-gray-600 mb-8">
                    In the next few steps, you'll provide a bit of information about your student's
                    needs so I can begin crafting a customized support plan.
                  </p>
                    ...
                    return (
                      ...
                      >
                        {type === "options" && (
                          <>
                            <h1 className="text-3xl font-bold text-gray-900 mb-8">
                              How can I help your student succeed?
                            </h1>
                        ...
                        {type === "test" && (
                          <>
                            ...
                            <input
                              ...
                              placeholder="e.g. Algebra II, Physics, Chemistry"
                        ...
                        {type === "master" && (
                          <>
                            <h1 className="text-3xl font-bold text-gray-900 mb-6">
                              Which subject does your student need help with?
                            </h1>
                        ...
                        {type === "study" && (
                          <>
                            <h1 className="text-3xl font-bold text-gray-900 mb-6">
                              What subjects is your student studying?
                            </h1>

                            <textarea
                              value={studySubjects}
                              onChange={(e) => setStudySubjects(e.target.value)}
                              placeholder="e.g. Chemistry, AP Biology, Calculus"
                              className="w-full border border-gray-300 px-4 py-3 rounded-lg text-lg mb-6 resize-none"
                            />

                            <h2 className="text-xl font-semibold text-gray-700 mb-4">
                              Which strategies are you interested in for your student:
                            </h2>

                            <div className="space-y-4 mb-6">
                              {[
                                ["memory", "Learn new memory techniques"],
                                ["learner", "Discover your student's effective learning style"],
                                ["ai", "Use AI tools to boost learning"],
                                ["combo", "Figure out what to focus on for test prep"],
                              ].map(([key, label]) => (
                                <motion.label
                                  key={key}
                                  whileTap={{ scale: 0.98 }}
              ...
              {step === "time-selection" && (
                ...
                >
                  <h1 className="text-3xl font-bold text-gray-900 mb-6">
                    Which days work best for your student's tutoring?
                  </h1>
          ...
          <div className="w-full">
            ...
            <ul className="mt-6 list-none space-y-4 text-lg text-gray-800">
              {[
                "Online tutoring has been proven to boost academic performance with flexible, personalized support.",
                "Students benefit most when matched with a tutor who understands their unique goals and challenges.",
                "The right tutor can build confidence, reduce stress, and make learning enjoyable again.",
              ].map((t, i) => (
                <li
                  key={i}
